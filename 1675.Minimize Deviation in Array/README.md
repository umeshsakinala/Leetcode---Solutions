# Leetcode---Solutions
<h2>
  <a href="https://leetcode.com/problems/minimize-deviation-in-array/description/">
...
<ul>
	<li>
    If the element is <strong>even</strong>, <strong>divide</strong> it by <code>2</code>.
    </li>
	<ul>
