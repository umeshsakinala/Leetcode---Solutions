# Leetcode---Solutions
<h2>
  <a href="https://leetcode.com/problems/is-graph-bipartite/description/">
...
<strong>Explanation:</strong> There is no way to partition the nodes into two independent sets such that every edge connects a node
in one and a node in the other.</pre>
